...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-d8tjlyq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-d8tjlyq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Rem1x-2019/python-xray-direct.git
cd container-d8tjlyq
```
...
```
docker attach container-d8tjlyq
```
